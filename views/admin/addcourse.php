    ...
    <section class="content">
       <div class="row">            
           <div class="col-md-12">
            ...
            <?php echo form_open_multipart('insert_course'); ?>
              <div class="box-body">
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" style="width: 100%;" name="course_details[]" required></textarea>
                        </div>
                      </div>
              ...
              <table id="example1" class="table table-bordered ">
                ...
                <tbody>
                 ...
                 <tr>
                      ...
                      <td><?php echo date('d-M-Y H:i:s',strtotime($value['c_name_updated'])); ?></td>
                      <td>  
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModalu<?php echo $value['c_name_id']; ?>"><span class="glyphicon glyphicon-pencil"></span></button>
                      </td>

                     <td>
                          <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModal<?php echo $value['c_name_id']; ?>"><span class="glyphicon glyphicon-trash"></span></button>  
                          
                      </td>
                  </tr>

              <div class="modal fade" id="myModal<?php echo $value['c_name_id']; ?>" role="dialog">
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <form action="<?php echo base_url('delete_course_name')?>" method="post">
                    <div class="modal-body">
                        <input type="hidden" name="course_id" value="<?php echo $value['c_name_id']; ?>">
               ...
               <div class="modal fade" id="myModalu<?php echo $value['c_name_id']; ?>" role="dialog">
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="<?php echo site_url('update_course_name')?>" method="post">
                    <div class="row">
                      <input type="hidden" name="course_id" value="<?php echo $value['c_name_id']; ?>">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>Course Name: <span style="color:red;">*</span></label>
                        <input type="text" name="course_name" class="form-control" placeholder="Course Name" value="<?php echo $value['course_name']; ?>" required>
                     ...
                     <div class="col-md-8">
                      <div class="form-group">
                        <label>Course Details: </label>
                        <textarea class="form-control" rows="4" style="width: 100%;" name="course_details"><?php echo $value['course_description']; ?>                           
                        </textarea>
                        </div>
                      </div>
