            ...
            <div class="box-header">
              ...
              <div class="col-md-12"><br/>
                ...
                <div class="row" >
                  ...
                  <form action="search_student_status" method="post">
                    <div class="box-body">
              ...
              <table id="example1" class="table table-bordered ">
                ...
                <tbody>
                 ...
                 <tr style="background-color: #fdebd0; border-top: 1px solid black;">
                      <td><?php echo $i; ?></td>
                      <td style="font-weight: bold;"> <?php echo $data['stud_fname']." ".$data['stud_lname'];?></td>
                      <td colspan="8"> </td>
                  </tr>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <input type="submit" class="btn btn-danger" name="del_studi" value="Yes..! Delete">
               ...
               <div class="modal fade" id="myModalu<?php echo $value['app_id']; ?>" role="dialog">
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <select name="stud_name" class="form-control">
                            <option value="<?php echo $data['stud_id']; ?>"><?php echo $data['stud_fname']." ".$data['stud_lname'];?></option>
                        </select>
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                     <button type="submit" class="btn btn-success" name="studi"> Update</button>
                    </form>
                    </div>
                  </div>
