...
<head>
    ...
    <!-- Morris Chart Css-->
    <link href="<?php echo base_url('admin_panel/plugins/morrisjs/morris.css'); ?>" rel="stylesheet" />

    <!-- Bootstrap Material Datetime Picker Css -->
    <link href="<?php echo base_url('admin_panel/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css'); ?>" rel="stylesheet" />

    <!-- Bootstrap DatePicker Css -->
    <link href="<?php echo base_url('admin_panel/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css'); ?>" rel="stylesheet" />

    <!-- Wait Me Css -->
    <link href="<?php echo base_url('admin_panel/plugins/waitme/waitMe.css" rel="stylesheet'); ?>" />

    <!-- Bootstrap Select Css -->
    <link href="<?php echo base_url('admin_panel/plugins/bootstrap-select/css/bootstrap-select.css'); ?>" rel="stylesheet" />
  

     <!-- Sweetalert Css -->
     <link href="<?php echo base_url('admin_panel/plugins/sweetalert/sweetalert.css'); ?>" rel="stylesheet" />
