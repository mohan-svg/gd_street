            ...
            <div class="box-header">
              ...
              <div class="col-md-12"><br/>
                ...
                <div class="row" >
                  ...
                  <form action="search_university_status" method="post">
                    <div class="box-body">
            ...
            <div class="box-body" style="overflow-x: scroll;">
              ...
              <table id="example1" class="table table-bordered ">
                ...
                <tbody>
                  ...
                  <?php
                      $i =0;
                      foreach($universityids as $key => $data)
                     {
                        $i++;
                    ?>
                 ...
                 <tr style="background-color: #fdebd0; border-top: 1px solid black;">
                      <td><?php echo $i; ?></td>
                      <td style="font-weight: bold;"> <?php echo $data['university_name'];?></td>
                      <td colspan="8"> </td>
                  </tr>

                    <?php $id= $data['u_name_id'];
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <input type="submit" class="btn btn-danger" name="del_univer" value="Yes..! Delete">
               ...
               <div class="modal fade" id="myModalu<?php echo $value['app_id']; ?>" role="dialog">
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                     <button type="submit" class="btn btn-success" name="univer"> Update</button>
                    </form>
                    </div>
                  </div>
