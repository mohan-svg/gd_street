...
|
*/
$config['base_url'] = 'http://localhost/Gradstreet/';
...
$config['smtp_hostname'] = "mail.gradstreet.in";
// smtp username
$config['smtp_username'] = "no-reply@gradstreet.in";
// smtp password
$config['smtp_password'] = "Vijeet8844++";
...
$config['activation_subject'] = "Account Created - Grad Street";
// activation email message
$config['activation_message'] = "<body><h4>Hi [first_name],</h4><h4>Thank you for registering with us.</h4> 
<p>Please use below login credentials to login in to Grad Street.</p><p>Click Here to Login: http://localhost/CodeIgniter-3.1.10/index.php/login </p><h4>Username: [email] </h4>
<h4>Password: [password] </h4> <h4>Thanks,</h4> <h4>Grad Street</h4></body>";


// activation email subject
$config['docs_received'] = "New Application Received-[university_name]";

// Student Data email message

$config['send_docs'] = $html_body;
